...
function(t, e) {
    ...
    ***************************************************************************** */
    ...
    var d = {
        init: function(t) {
            t.window = (0, r.default)(window), t.document = (0, r.default)(document), t.html = (0, r.default)("html"), t.body = (0, r.default)("body"), t.viewport = (0, r.default)("html,body"), t.view = (0, r.default)("#view-main"), t.loader = (0, r.default)(".app-loader_overlay"), t.navbar = (0, r.default)(".app-navbar"), t.menu = (0, r.default)(".app-menu"), t.content = t.view.find(".app-content"), t.menuItems = t.menu.find(".app-menu-nav-item"), t.browser = (0, s.default)(), t.mobile = t.browser.mobile || !!t.browser.os.match(/android/i), t.html.removeClass("no-js").addClass(t.mobile ? "mobile" : "desktop").addClass(t.browser.name), t.mobile || (0, o.default)(), t.mobile ? t.window.on("scroll", function(e) {
            ...
            }, t.view.find("").each(function() {})
        },
        away: function(t) {},
        update: function(t) {
            var e = t.req.html,
                n = e.filter("#view-main"),
                i = e.filter(".app-navbar"),
    ...
    var a = {
        init: function(t, e) {
            var n = this,
                s = t.view;
            t.navbar.find(".app-navbar-logo").on("click", function(e) {
                    e.preventDefault(), t.scrollTo(0, 0)
                }),
                function() {
                    var e = t.menu.find(".app-menu-toggle"),
                        n = t.navbar.find(".app-navbar-menu-close button"),
