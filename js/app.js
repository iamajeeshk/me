(function ($) {
  ...
  function init_menu_toggle() {
    $(".ak-menu-togggle").on("click", function () {
      $("#body-app").toggleClass("ak-menu-open");
    });
  ...
  function init_inner_link() {
    $(".ak-inner-link").on("click", function () {
  ...
  function init_typed() {
    ...
    if ($typed.length) {
      var typed = new Typed("#typed", {
        strings: ["front-end developer", "web designer", "web marketer", "web tester"],
        loop: true,
        typeSpeed: 70
      });
    }
